...
def initial_permutation():
    ...
    for i in range(iterations_required):
        ...
        print("*"*10)
        mapping(initial_permutation_table,initial_permutation_binary_table)
...
def permuted_choice_1():
    ...
    pc1_split_1=pc1_permutation_result[:28]
    pc1_split_2=pc1_permutation_result[28:]
    return pc1_split_1,pc1_split_2

def circular_left_shift(cls_inp1,cls_inp2,n):
    for i in range(n):
